        ...
        <fieldset className="counsil-field">
          ...
          <div className="field">
            ...
            >
              ...
              <MenuItem value="BBAF">BS Accounting and Finance</MenuItem>
              <MenuItem value="BBAL">Bachelors in Laws</MenuItem>
              <MenuItem value="BBAM">BS Aviation Management.</MenuItem>
              <MenuItem value="BBCommerce">BS Commerce</MenuItem>
              <MenuItem value="MBBS">Medical</MenuItem>
