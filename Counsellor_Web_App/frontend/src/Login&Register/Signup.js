...
const Signup = () => {
  ...
  const handleSubmit = async (e) =>{
    e.preventDefault()
    // await signup(formval.email, formval.password, formval.fullname, formval.CNIC, formval.Gender, formval.DOB, formval.Nationality, formval.HomeAddress, formval.ContactNo, formval.FathersName, formval.FatherCNIC, formval.FatherContactNo)
