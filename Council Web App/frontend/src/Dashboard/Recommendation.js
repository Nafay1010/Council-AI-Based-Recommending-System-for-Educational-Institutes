...
const Recommendation = () => {
  ...
  // console.log("matric in recommendation: ", matric_marks);
  // console.log("inter in recommendation: ", inter_marks);
    ...
    return (
      <div className="search-content">
        <div className="recommendation-list">
          ...
          <h2 style={{ fontWeight: "100", fontWeight: "normal" }}>
            Try the following approaches:
          </h2>
          <div className="guide">
            <h2 style={{ fontWeight: "normal", marginTop: "10px" }}>
              - Reload the page but choose a different machine learning
              algorithm
            </h2>
            <h2 style={{ fontWeight: "normal", marginTop: "10px" }}>
            ...
            <h2 style={{ fontWeight: "normal", marginTop: "10px" }}>
              - Your budget might be too low, try again but this time increasing
              budget.
            </h2>
          </div>
      ...
      <>
        <div className="search-content">
          <div className="recommendation-heading">
            ...
            >
              The following list of educational institutions has been generated
            ...
            <Box sx={{ width: "100%", mb: 3 }}>
              <Collapse in={open}>
                ...
                >
                  ...
                  university from the list. Click the "Feedback" button next to
                  your preferred university to submit your preference. Your
                  feedback will help us improve our recommendations. Please note
                  that you can only give feedback{" "}
          ...
          <div className="recommendation-list">
            <div className="accuracy">
              <div className="ribbon ribbon-top-right">
                <span style={{ fontSize: "12px" }}>91% Accuracy</span>
              </div>
            </div>
            {!universities ? (
